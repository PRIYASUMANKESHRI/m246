...
class Interceptor extends \Magento\SalesRule\Block\Adminhtml\Promo\Quote\Edit\Tab\Coupons\Form implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGenerateUrl');
        return $pluginInfo ? $this->___callPlugins('getGenerateUrl', func_get_args(), $pluginInfo) : parent::getGenerateUrl();
    }
