...
class Interceptor extends \Magento\Quote\Model\Quote\Address\Item implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function setAddress(\Magento\Quote\Model\Quote\Address $address)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setAddress', func_get_args(), $pluginInfo) : parent::setAddress($address);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'importQuoteItem');
        return $pluginInfo ? $this->___callPlugins('importQuoteItem', func_get_args(), $pluginInfo) : parent::importQuoteItem($quoteItem);
    }
    ...
    public function setPrice($value)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setPrice', func_get_args(), $pluginInfo) : parent::setPrice($value);
    }
